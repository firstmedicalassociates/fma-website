...
const manifest = JSON.parse(await fs.readFile(new URL("../data/asana-content-updates-2026-09-23.json", import.meta.url), "utf8"));
...
try {
  ...
  if (apply && pending.length) {
    await fs.mkdir("artifacts/site-audit/asana-2026-09-23", { recursive: true });
    const backup = `artifacts/site-audit/asana-2026-09-23/content-backup-${Date.now()}.json`;
