...
/**
 * Populate embeddings for searchable content
 * Run with: node scripts/populate-embeddings.js
 */
...
if (!process.env.DATABASE_URL) {
  console.error('ERROR: DATABASE_URL environment variable not found in .env');
  process.exit(1);
}
...
async function main() {
  try {
    console.log('🚀 Starting AI Search Embedding Population...\n');
