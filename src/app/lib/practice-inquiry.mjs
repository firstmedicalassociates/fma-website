...
function emailFrame({ title, preheader, body }) {
  ...
  <tr><td align="left" style="padding:26px 30px;background:#001c55;border-bottom:5px solid #418fca;"><a href="https://drsfirst.com/" style="text-decoration:none;"><img src="https://drsfirst.com/email-logo-white.png" width="180" height="56" alt="First Medical Associates" style="display:block;width:180px;height:auto;max-width:100%;border:0;outline:none;color:#ffffff;font-family:Georgia,'Times New Roman',serif;font-size:20px;font-weight:700;"></a></td></tr>
