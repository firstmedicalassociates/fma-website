...
export default function PatientsPage() {
  const forms = [
    ...
    },
    {
      ...
      href: '/wp-content/uploads/2023/04/FMA-MR-release-4.18.23.pdf',
      action: 'Open PDF',
      external: true,
    },
    {
      ...
      href: '/wp-content/uploads/2023/04/FMA-Physical-vs-problem-based-4.18.23.pdf',
      action: 'Open PDF',
      external: true,
    },
    {
      ...
      href: '/wp-content/uploads/2023/04/FMA-HIPPA-for-family-member-4.18.23.pdf',
      action: 'Open PDF',
      external: true,
    },
    {
      ...
      href: '/wp-content/uploads/2023/04/FMA-MR-request-4.18.23.pdf',
      action: 'Open PDF',
      external: true,
    },
    {
      ...
      href: '/wp-content/uploads/2023/04/FMA-HIPPA-privacy-notice-website-4.18.23.pdf',
      action: 'Open PDF',
      external: true,
    },
    {
      ...
      href: '/wp-content/uploads/2025/03/FMLA-Disability-and-Other-Forms.docx.pdf',
      action: 'Open PDF',
      external: true,
    },
    {
      ...
      href: '/wp-content/uploads/2026/07/Late-Arrival-Policy-FMA_07-17-2026.docx-2.pdf',
      action: 'Open PDF',
      external: true,
    },
    {
      ...
      href: '/wp-content/uploads/2026/02/GLP-1-Medications-Insurance-Coverage.pdf',
      action: 'Open PDF',
      external: true,
    },
    {
      ...
      href: '/wp-content/uploads/2026/03/Policy-Regarding-GLP-1-Weight-Loss-Medications-.docx.pdf',
      action: 'Open PDF',
      external: true,
    },
  ];
