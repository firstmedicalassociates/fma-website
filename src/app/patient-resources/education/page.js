  ...
  return (
    <div className="education-content">
      <style>{`
        ...
        .feat-btn { color: #0070f3; font-weight: 700; display: flex; align-items: center; gap: 0.5rem; }
        ...
        .side-link { color: #0070f3; font-weight: 700; font-size: 0.8125rem; display: flex; align-items: center; gap: 0.5rem; margin-top: auto; }
      ...
      <div className="cat-hero-row">
         {topCategories.map((cat, i) => (
           <button key={i} className="edu-cat-card">
              <span>{cat.label}</span>
         ...
         <div className="main-feat">
            ...
            <div className="feat-body">
               ...
               <div className="feat-footer">
                  <button className="feat-btn">Read Guide <ArrowRight size={18} /></button>
         ...
         <div className="side-col">
            <div className="side-row-cards">
               <div className="side-sq-card">
                 ...
                 <button className="side-link">Explore Tips <ArrowRight size={16} /></button>
               </div>
               <div className="side-sq-card">
                 ...
                 <button className="side-link">View Guide <ArrowRight size={16} /></button>
               </div>
            </div>
            ...
            <div className="wide-card">
               ...
               <div className="wide-body">
                  ...
                  <button className="side-link">Read Guide <ArrowRight size={16} /></button>
               </div>
            </div>
         </div>
      </div>
