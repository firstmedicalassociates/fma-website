    ...
    setSections((current) =>
      current.map((section) =>
        section.id === sectionId
          ? {
              ...section,
              elements: [...section.elements, createElement(nextType)],
            }
          : section,
      ),
    );
      ...
      <header className="admin-top">
        <div>
          ...
          <p className="admin-subtitle">
            Header and footer are required. Add sections and place elements
            inside them.
          </p>
        </div>
        ...
        <div className="builder-card">
          <div className="builder-card-header">
            ...
            <p className="builder-card-copy">
              Build the article structure, upload a featured image, and preview
              the final content as you go.
            </p>
          </div>
              ...
              previewSections.map((section) => (
                <section key={section.id}>
                  {section.elements.map((element) => {
                    if (element.type === "h2")
                      return <h2 key={element.id}>{element.content}</h2>;
                    if (element.type === "p")
